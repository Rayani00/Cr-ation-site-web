...
<?php
     if(isset($_SESSION["newInscription"]) && $_SESSION["newInscription"] == false ){
         echo("<script>alert('Inscription non reussite, veuillez ressayer plus tard')</script>");
    ...
    <div class="container">
       <h2 class="hedaing-title text-center">INSCRIPTION</h2>
       <div class="row">
         <form id="formulaire" class="form-inline" action="inscriptiontraitement.php" method="post">
